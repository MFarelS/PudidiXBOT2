	...
	client.on('message-new', async (mek) => {
		try {
            ...
            break	
				case 'gtts':	
				case 'tts':
					if (args.length < 1) return client.sendMessage(from, '𝗱𝗶𝗽𝗲𝗿𝗹𝘂𝗸𝗮𝗻 𝗸𝗼𝗱𝗲 𝗯𝗮𝗵𝗮𝘀𝗮 *!*', text, {quoted: mek})
			...
			case 'loli': 
				...
				case 'nsfwloli': 
				    try {
						if (!isNsfw) return reply('𝗠𝗮𝗮𝗳 𝗳𝗶𝘁𝘂𝗿 𝗶𝗻𝗶 𝗯𝗲𝗹𝘂𝗺 𝗱𝗶 𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻/𝗸𝗲𝘀𝗮𝗹𝗮𝗵𝗮𝗻 𝘀𝗲𝗿𝘃𝗲𝗿.')
...
break
				...
				case 'tagall':
					...
					break
				case 'clearall':
					if (!isOwner) return reply('_𝗔𝗻𝗱𝗮 𝗦𝗶𝗮𝗽𝗮 𝗚𝗮𝗻_ _*?*_')
